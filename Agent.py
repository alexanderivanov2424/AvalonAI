...
"""
Class to hold Recurrent Policy Gradient Network
"""
...
Uses model defined above and interfaces with Game code.
"""
class AvalonPlayer(Player):
    ...
    def loss_function(self, did_win):
        # calculate loss for actions take so far
        loss = 0
